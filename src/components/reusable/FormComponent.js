  ...
  return (
    ...
    <>
        ...
        <details>
            ...
            <p>PERRO <input type='radio' name='pet' onClick={ () => setPet('PERRO') }/> </p>
            <p>GATO <input type='radio' name='pet' onClick={() => setPet('GATO')}/></p>
        ...
        <details style={{zIndex: '1'}}>
            ...
            <p>CACHORRO <input type='radio' name='age' onClick={ () => setAge('CACHORRO') }/> </p>
            <p>ADULTO <input type='radio' name='age' onClick={ () => setAge('ADULTO')}/></p>
